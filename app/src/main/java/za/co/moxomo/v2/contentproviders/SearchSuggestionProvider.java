...
import za.co.moxomo.v2.databasehelpers.SearchSuggestionDatabaseHelper;


public class SearchSuggestionProvider extends ContentProvider {

    private static final String PROVIDER_NAME = "za.co.moxomo.v2.contentproviders.SEARCH";
